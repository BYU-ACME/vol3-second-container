# ACME Docker Container for Volume 3 Second Semester Labs

This repository contains the official Docker container for ACME Volume 3 Second Semester Labs. The container is fully set up with all required tools and libraries to ensure a consistent coding environment for all students and graders.
